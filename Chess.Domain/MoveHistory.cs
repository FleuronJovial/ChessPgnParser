    ...
    public sealed class MoveHistory : IXmlSerializable
    {
        ...
        public struct PackedBoard
        {
            ...
            public void LoadFromStream(BinaryReader reader)
            {
                ...
                m_info = (BoardStateMask)reader.ReadInt32();
            }
        }
        ...
        public void LoadFromStream(BinaryReader reader)
        {
            ...
            for (int i = 0; i < m_moveCount; i++)
            {
                ...
                zobristKey = ZobristKeyUtil.ComputeBoardZobristKey(board) ^ (int)packedBoard.m_info;
        ...
        /// </returns>
        public RepeatResult AddCurrentPackedBoard(long zobristKey, bool isPawnMoveOrPieceEaten)
        {
            RepeatResult retVal = RepeatResult.NoRepeat;
            int hashIndex;
            int newArraySize;
            byte count;
            ...
            else
            {
                ...
                {
                    retVal = RepeatResult.FiftyRuleRepeat;
                }
                else
                {
                    ...
                    {
                        retVal = RepeatResult.ThreeFoldRepeat;
                    }
                }
            }
        ...
        /// Result: NoRepeat, ThreeFoldRepeat or FiftyRuleRepeat
        /// </returns>
        public RepeatResult CurrentRepeatResult(long zobristKey)
        {
            RepeatResult retVal = RepeatResult.NoRepeat;
            int hashIndex;
            byte count;
        ...
        /// </returns>
        private static long ComputePackedValue(PieceType[] board, int startPos)
        {
            long retVal = 0;
        ...
        public static PackedBoard ComputePackedBoard(PieceType[] board, BoardStateMask info)
        {
            PackedBoard packedBoard;
            ...
            packedBoard.m_info = info & ~BoardStateMask.BlackToMove;
            return packedBoard;
        }
        ...
        private static void UnpackBoardValue(long val, PieceType[] board, int startPos)
        {
            for (int i = 0; i < 16; i++)
            {
                board[startPos + i] = (PieceType)((val >> (i << 2)) & 15);
            }
        }
        ...
        /// <param name="board">       Board array</param>
        public static void UnpackBoard(PackedBoard packedBoard, PieceType[] board)
        {
        ...
        /// <param name="board"> Board array</param>
        /// <param name="info">  Board extra info</param>
        public void Reset(PieceType[] board, BoardStateMask info)
        {
        ...
        public void UpdateCurrentPackedBoard(int pos, PieceType newPieceType)
        {
            long newPiece;
            long mask;
            int slotInValue;
