...
namespace Chess.Domain
{
    ...
    /// </summary>
    public static class ZobristKeyUtil
    {
        ...
        public static long UpdateZobristKey(long zobristKey, int pos, PieceType oldPiece, PieceType newPiece)
        {
            int baseIndex;
        ...
        public static long ComputeBoardZobristKey(PieceType[] board)
        {
            long retVal = 0;
